...
function draw()
{
  ...
  var lineObj10 = $("#line-obj-10").position();
  var lineObj11 = $("#line-obj-11").position();
  var lineObj12 = $("#line-obj-12").position();
  ...
  y += h;
  h = lineObj10.top - lineObj09.top;
  vectorPath01_reset(x,y,w,h);
  vectorPath01_draw(2);

  y += h;
  h = lineObj11.top - lineObj10.top;
  vectorPath01_reset(x,y,w,h);
  vectorPath01_draw(2);

  y += h;
  h = lineObj12.top - lineObj11.top;
  vectorPath01_reset(x,y,w,h);
  vectorPath01_draw(2);

  y += h;
  h = lineObj13.top - lineObj12.top;
  vectorPath01_reset(x,y,w,h);
  vectorPath01_draw(2);

  start = $("#line-pre-03").position();
  var lineObj14 = $("#line-obj-14").position();
  var lineObj15 = $("#line-obj-15").position();
  var lineObj16 = $("#line-obj-16").position();
  ...
  y += h;
  h = lineObj16.top - lineObj15.top;
  vectorPath01_reset(x,y,w,h);
  vectorPath01_draw(2);

  y += h;
  h = lineObj17.top - lineObj16.top;
  vectorPath01_reset(x,y,w,h);
  vectorPath01_draw(2);
}
